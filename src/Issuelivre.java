...
public class Issuelivre extends JFrame implements ActionListener{
    ...
    private JTextField t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t12,t13,t14;
	...
	JLabel l3 = new JLabel("auteur");
	l3.setForeground(Color.WHITE);
	l3.setFont(new Font("Tahoma", Font.BOLD, 14));
	l3.setBounds(47, 131, 100, 23);
	contentPane.add(l3);

	JLabel l4 = new JLabel("Publier");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Details-Livre",
	...
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(70, 130, 180), 2, true), "Details Utilisateur",
    ...
    public void actionPerformed(ActionEvent ae){
		...
		ResultSet rs = st.executeQuery();
                ...
                while (rs.next()) {
                    ...
                    t3.setText(rs.getString("auteur"));
                    t4.setText(rs.getString("publier"));
                    t5.setText(rs.getString("edition"));
                    t6.setText(rs.getString("prix"));
                    t7.setText(rs.getString("nb_pages"));
		}
		st.close();
		rs.close();
		...
		ResultSet rs = st.executeQuery();
                ...
                while (rs.next()) {
                    ...
                    t12.setText(rs.getString("licence"));
		...
		rs.close();
            ...
            if(ae.getSource() == b3){
                    try{
                String sql = "insert into issueBook(id_book, student_id, bname, sname,  branch, dateOfIssue) values( ?, ?, ?, ?, ?, ?)";
		PreparedStatement st = con.c.prepareStatement(sql);
		st.setString(1, t1.getText());
		...
		if (i > 0)
                    JOptionPane.showMessageDialog(null, "Livre issued..!");
		else
